...
namespace HalfbyteMedia.OnARoll.MakioClient.UI
{
    public static class DisplayManager
    {
        ...
        public static void SetDisplay(int display)
        {
            ...
            {
                MakioClient.LogWarning($"Cannot set display index to {display} as there are not enough monitors connected!");
        ...
        private static IEnumerator FixPanels()
        {
            ...
            foreach (Panels.Panel panel in UIManager.UIPanels.Values)
            {
