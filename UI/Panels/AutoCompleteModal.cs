...
{
    public class AutoCompleteModal : Panel
    {
        ...
        {
            return Suggesting(handler) && Input.GetKeyDown(KeyCode.Return);
        }

        public static bool CheckEscape(ISuggestionProvider handler)
        {
            return Suggesting(handler) && Input.GetKeyDown(KeyCode.Escape);
        }
        ...
        public void UpdatePosition()
        {
            ...
            if (CurrentHandler.AnchorToCaretPosition)
            {
                ...
                //TextGenerator textGen = input.Component.;
