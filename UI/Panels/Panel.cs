...
namespace HalfbyteMedia.OnARoll.MakioClient.UI.Panels
{
    ...
    {
        protected Panel(UIBase owner) : base(owner) { }
        ...
        protected override UniverseLib.UI.Panels.PanelDragger CreatePanelDragger() => new(this);
        ...
        public virtual string ToSaveData()
        {
            ...
            {
                MakioClient.LogWarning($"Exception generating Panel save data: {ex}");
                return "";
            }
        }
        ...
        protected virtual void ApplySaveData(string data)
        {
            ...
            {
                MakioClient.LogWarning("Invalid or corrupt panel save data! Restoring to default.");
        ...
        protected override void LateConstructUI()
        {
            ...
            {
                MakioClient.Log($"Exception loading panel save data: {ex}");
                SetDefaultSizeAndPosition();
            }
