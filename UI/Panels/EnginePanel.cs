using HalfbyteMedia.OnARoll.MakioClient.CacheObject;
using HalfbyteMedia.OnARoll.MakioClient.CacheObject.Views;
...
{
    public class EnginePanel : Panel, ICacheObjectController, ICellPoolDataSource<ConfigEntryCell>
    {
        public override string Name => "Engine";
        public override UIManager.Panels PanelType => UIManager.Panels.Engine;
        ...
        public EnginePanel(UIBase owner) : base(owner)
        {
            foreach (KeyValuePair<string, IConfigElement> entry in ConfigManager.EgnineConfigs)
            {
