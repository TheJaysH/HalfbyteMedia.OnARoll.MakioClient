...
using HalfbyteMedia.OnARoll.MakioClient.UI.Widgets.AutoComplete;
...
namespace HalfbyteMedia.OnARoll.MakioClient.CacheObject.IValues
{
    public class InteractiveEnum : InteractiveValue
    {
        ...
        private void SetTogglesForValue(object value)
        {
            ...
            {
                MakioClient.LogWarning("Exception setting flag toggles: " + ex);
            }
        }
        ...
        private void OnApplyClicked()
        {
            ...
            {
                MakioClient.LogWarning("Exception setting from dropdown: " + ex);
            }
        }
        ...
        private void SetValueFromFlags()
        {
            ...
            {
                MakioClient.LogWarning("Exception setting from flag toggles: " + ex);
            }
        }
