...
namespace HalfbyteMedia.OnARoll.MakioClient.CacheObject.Views
{
    public class ConfigEntryCell : CacheObjectCell
    {
        public override GameObject CreateContent(GameObject parent)
        {
            ...
            ResetButton = UIFactory.CreateButton(horiGroup, "ResetButton", "Reset", new Color(0.15f, 0.19f, 0.15f));
            UIFactory.SetLayoutElement(ResetButton.Component.gameObject, minWidth: 70, minHeight: 25, flexibleWidth: 0, flexibleHeight: 0);
            ResetButton.OnClick += ResetClicked;
