using HalfbyteMedia.OnARoll.MakioClient.CacheObject.IValues;
using HalfbyteMedia.OnARoll.MakioClient.CacheObject.Views;
using System.Collections;
using UniverseLib.UI;
using UniverseLib.UI.ObjectPool;

namespace HalfbyteMedia.OnARoll.MakioClient.CacheObject
{
    ...
    public abstract class CacheObjectBase
    {
        ...
        public virtual void OnCellApplyClicked()
        {
            ...
            else
            {
                ...
                {
                    MakioClient.LogWarning("Unable to parse input!");
                    if (ex != null)
                        MakioClient.Log(ex.ReflectionExToString());
                }
            }
